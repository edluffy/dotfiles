...
onoremap <silent> <Plug>(coc-classobj-a) :call coc#rpc#request('selectClass', [v:false, ''])
onoremap <silent> <Plug>(coc-classobj-i) :call coc#rpc#request('selectClass', [v:true, ''])
vnoremap <silent> <Plug>(coc-classobj-a) :call coc#rpc#request('selectClass', [v:false, visualmode()])
vnoremap <silent> <Plug>(coc-classobj-i) :call coc#rpc#request('selectClass', [v:true, visualmode()])
...
set laststatus=2
set ruler
set runtimepath=~/.vim,~/.vim/plugged/coc.nvim,~/.vim/plugged/vim-polyglot,/usr/local/Cellar/macvim/8.2-163/MacVim.app/Contents/Resources/vim/vimfiles,/usr/local/Cellar/macvim/8.2-163/MacVim.app/Contents/Resources/vim/runtime,/usr/local/Cellar/macvim/8.2-163/MacVim.app/Contents/Resources/vim/vimfiles/after,~/.vim/plugged/vim-polyglot/after,~/.vim/after,/usr/local/opt/fzf,/usr/share/doc/fzf/examples,~/.config/coc/extensions/node_modules/coc-snippets
